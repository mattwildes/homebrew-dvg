cask 'facilis-client-721' do
  ...
  url 'https://dvg-installers.s3.amazonaws.com/Facilis/7.2.1/Facilis+Mac+Client+7.2.1.dmg'
  name 'Facilis Mac Client 7.2.1'
  homepage 'https://www.facilis.com'

  installer script: {
                      executable:   "#{staged_path}/Facilis Mac Client 7.2.1.app/Contents/Resources/factbsetup",
                      args:         ['install'],
                      sudo:         true,
                      print_stderr: false,
                    }
